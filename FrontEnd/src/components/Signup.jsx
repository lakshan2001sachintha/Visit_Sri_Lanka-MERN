...
function Signup({isOpen,onClose}) {
  return (
    <div className={`fixed top-0 right-0 h-full w-1/3 bg-white shadow-lg transform ${
      ...
      <div className="p-6">
        ...
        <h2 className="text-2xl font-bold text-center text-white bg-yellow-600 px-4 py-4 mb-8">Sign Up</h2>
        ...
        <form>
          ...
          <button className="w-1/2 bg-yellow-600 text-white py-2 rounded-lg hover:bg-yellow-400 transition">
            Sign Up
          </button>
        </form>
      </div>
